...
if (salario <= 2000.0) {
  ...
  let imposto = 80.0 + (salario - 3000.0) * 0.18;  //o imposto é calculado como R$ 80,00 mais 18%
  ...
  console.log('R$ ' + imposto.toFixed(2));         //o imposto é calculado como R$ 350,00 mais 28% 
